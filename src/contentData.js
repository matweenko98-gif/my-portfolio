...
const contentData = {
  ...
  hero: {
    ...
    subtitle: "Создаю коммерческие лендинги, многостраничные сайты и&nbsp;интернет-магазины под&nbsp;ключ на&nbsp;Tilda. Для сложных задач разрабатываю<br className='hidden min-[1440px]:block' /> веб-приложения (MVP) и&nbsp;сервисы. Использую AI-разработку, чтобы быстро собрать и&nbsp;протестировать продукт",
    buttons: {
      primary: {
