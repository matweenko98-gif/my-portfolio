...
const contentData = {
  ...
  hero: {
    ...
    subtitle: "Создаю коммерческие лендинги, многостраничные сайты и&nbsp;интернет-магазины под&nbsp;ключ на&nbsp;Tilda. Для сложных задач разрабатываю<br class='hidden lg:block' /> веб-приложения (MVP) и&nbsp;ИИ-сервисы на&nbsp;React.",
